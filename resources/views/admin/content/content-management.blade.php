        ...
        $(document).ready(function() {
            ...
            function initFormBuilder() {
                if (initialFormData) {
                    ...
                    if (steps.length === 0) {
                        toastr.error('No steps found in form.');
                        return;
                    }
                    renderSteps();
                } else {
            ...
            function renderSteps() {
                ...
                steps.forEach((step, index) => {
                    ...
                    loadElements(step.id); // Load elements for this step
                });
            }
            ...
            $(document).on('click', '.delete-element', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            $card.remove(); // Remove the element from the DOM immediately
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="options-container">
                                                    ${element.options?.map((opt, idx) => `
                                                        ...
                                                        `).join('') || ''}
                                                    <button type="button" class="btn btn-outline-secondary btn-sm add-option ms-2">
                                                        <i class="fas fa-plus"></i> Add Option
                                                    </button>
                                                </div>
                                                <div class="d-flex justify-content-end align-items-center mt-3">
